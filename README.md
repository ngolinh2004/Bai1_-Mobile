...
2. Đăng ký tài khoản cloudflare
   <img width="956" height="341" alt="{1D92912F-25E0-4AB0-9E75-A7057C39AA2B}" src="https://github.com/user-attachments/assets/6e239fed-5075-4092-9979-667e2e8de1c5" />

3. Thêm domain đã đăng ký vào trong cloudflare : Nhận 2 dòng namespace
   <img width="953" height="370" alt="{A265344E-5BCD-468D-BE11-6F3B0B980C80}" src="https://github.com/user-attachments/assets/11cc109d-aa82-460f-a1c4-eb14d4877470" />
